 ...
 * @author ING
 */
public class DialogoRegistrarReferenciaAceite extends javax.swing.JDialog {
    ...
    public DialogoRegistrarReferenciaAceite(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void Cargar(String t) {
        ...
        conexion.conectar();
        String sql = "SELECT * FROM referenciadeaceite WHERE nombre_referenciaaceite ILIKE '%" + t + "%' ORDER BY id_referenciaaceite DESC";        
        ...
        try {
            ...
            Logger.getLogger(DialogoRegistrarReferenciaAceite.class.getName()).log(Level.SEVERE, null, ex);
        }finally{
            conexion.CERRAR();
        }
    }
    ...
    public void Guardar() {
        if (!cjnombreliquido.getText().isEmpty()) {
            ...
            String GuardarNombre = "INSERT INTO referenciadeaceite (nombre_referenciaaceite) VALUES ('" + nombre + "') ";
    ...
    private void initComponents() {
        ...
        setTitle("Referencia de Aceite");

        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("Ingrese la Raferencia del Aceite"));
    ...
    private void EliminarTipoDeTransformadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EliminarTipoDeTransformadorActionPerformed
        if (TablaMarcas.getSelectedRow() != -1) {
            String sql = "DELETE FROM referenciadeaceite WHERE id_referenciaaceite='" + TablaMarcas.getValueAt(TablaMarcas.getSelectedRow(), 0) + "' ";
            if (JOptionPane.showConfirmDialog(this, "Desea eliminar el registro seleccionado", "Referencia de Aceite: " + TablaMarcas.getValueAt(TablaMarcas.getSelectedRow(), 1), JOptionPane.DEFAULT_OPTION) == JOptionPane.YES_OPTION) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogoRegistrarReferenciaAceite.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                DialogoRegistrarReferenciaAceite dialog = new DialogoRegistrarReferenciaAceite(new javax.swing.JFrame(), true);
